export default async function handler(req, res) {
  ...
  const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyTxHV8SGHZkJFT2MbxKE3K_4Kpr22yZD6eZaUDnXzCdNUgu3PSlQ6SPJ_UY15xImSf6g/exec";
...
if (req.method === "POST" && MODE === "reparasi") {
  try {
    const response = await fetch("https://script.google.com/macros/s/AKfycbyTxHV8SGHZkJFT2MbxKE3K_4Kpr22yZD6eZaUDnXzCdNUgu3PSlQ6SPJ_UY15xImSf6g/exec?mode=reparasi", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(req.body)
    });
