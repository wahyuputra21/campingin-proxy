export default async function handler(req, res) {
  ...
  const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwIxj7eU4Z3t9xvR9NZL1ECgigjYK5lgPPw-RXlvTtFn9a4EXFUbQ5YRo1Mu-It94k4-Q/exec";
...
if (req.method === "POST" && MODE === "reparasi") {
  try {
    const response = await fetch("https://script.google.com/macros/s/AKfycbwIxj7eU4Z3t9xvR9NZL1ECgigjYK5lgPPw-RXlvTtFn9a4EXFUbQ5YRo1Mu-It94k4-Q/exec?mode=reparasi", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(req.body)
    });
